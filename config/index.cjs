...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'Nq9GkASQFKMzcauiCP4B0SpYZ_QAHJ3wfWDBb5-Drcc',
  ...
  CALLBACK_TEMPLATE_ID: 'Nq9GkASQFKMzcauiCP4B0SpYZ_QAHJ3wfWDBb5-Drcc',

  CALLBACK_USERS: [
    {
      name: '杜杜',
      // 使用微信测试号：自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oVsC45n2ntESCee-tTybo-ef6mwg',
    }
  ],

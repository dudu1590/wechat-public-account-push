...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'Py3Quadax7QbSL2n9kgi7rkSCAw4bhSMEhhgQqWSAVQ',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝宝', year: '2002', date: '05-06',
        },
        {
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2022-10-12' },
      ],
    },
  ],
  ...
  CALLBACK_TEMPLATE_ID: 'Py3Quadax7QbSL2n9kgi7rkSCAw4bhSMEhhgQqWSAVQ',
